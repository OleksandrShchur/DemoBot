        ...
        private static async Task BotOnMessageReceived(ITelegramBotClient botClient, Message message)
        {
            ...
            static async Task<Message> SendInlineKeyboard(ITelegramBotClient botClient, Message message)
            {
                ...
                InlineKeyboardMarkup inlineKeyboard = new(
                    ...
                    new []
                    {
                        InlineKeyboardButton.WithCallbackData("Data 1", "1"),
                        InlineKeyboardButton.WithCallbackData("Data 2", "2"),
                    },
                    // second row
                    new []
                    {
                        InlineKeyboardButton.WithCallbackData("Data 3", "3"),
                        InlineKeyboardButton.WithCallbackData("Data 4", "some other text"),
                    },
                    });
            ...
            static async Task<Message> SendReplyKeyboard(ITelegramBotClient botClient, Message message)
            {
                ReplyKeyboardMarkup replyKeyboardMarkup = new(
                    new[]
                    {
                        new KeyboardButton[] { "Button 1", "Button 2", "Button new" },
            ...
            static async Task<Message> RequestContactAndLocation(ITelegramBotClient botClient, Message message)
            {
                ...
                return await botClient.SendTextMessageAsync(chatId: message.Chat.Id,
                                                            text: "Where or who are you?",
                                                            replyMarkup: RequestReplyKeyboard);
            }

            static async Task<Message> Usage(ITelegramBotClient botClient, Message message)
            {
                const string usage = "Select option:\n" +
